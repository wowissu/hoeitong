...
<div class="pagebox" :id="id">
    <div class="pagebox_inner">
        <div class="pagebox_layout" :class="{
        ...
        <div :belong="id" class="pagebox_sidebar" :class="{
            ...
            <ul class="pagebox_menu">
                <li class="pagebox_menu_li" v-show="!item.hidden"
                    v-for="(item, index) in menu" :key="index"
                    :class="{pagebox_menu_li__disable: item.disable}"
                >
